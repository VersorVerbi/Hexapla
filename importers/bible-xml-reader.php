...
class HexaplaStandardMetadata {
    ...
    public function upload(&$db): int {
        ...
        $criteria[HexaplaSourceVersion::ALLOWS_ACTIONS] = HexaplaPermissions::NOTE + HexaplaPermissions::FOCUS + HexaplaPermissions::DIFF; // TODO: handle when diffing isn't allowed
